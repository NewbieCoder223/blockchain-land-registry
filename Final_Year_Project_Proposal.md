...
**Author:** Manus AI**Date:** February 12, 2026**Project Type:** Undergraduate Final-Year Project (IEEE/ACM Standard)
...
1. **Implement** modular smart contracts in Solidity to automate title registration and ownership transfer.

1. **Develop** a user-friendly web interface using Python (Flask) that accounts for low digital literacy.

1. **Integrate** ethical mechanisms for community consent and dispute flagging.

1. **Evaluate** the system's performance (latency, throughput) and usability through simulated low-resource benchmarks.

### 5.2 Hypotheses

- **H1:** Implementing a blockchain‑based ledger will significantly reduce the incidence of unauthorized record alterations compared to centralized databases, thanks to the system’s immutable and publicly verifiable record of transactions
...
1. **Land Title Registration:** The initial "minting" of a digital land title by an authorized Registrar.

1. **Ownership Transfer:** A smart contract-driven process that requires multi-party approval to update the ledger.

1. **Record Verification:** A public-facing module allowing anyone to verify a title's authenticity using its unique ID.

1. **Dispute Flagging:** A mechanism for owners to "freeze" a title on-chain in case of a legal dispute.

1. **Off-Chain Hashing:** Automatic generation of SHA-256 hashes for all uploaded survey plans and deeds.
...
| **Landano** [8] | Africa | Focus on Cardano-based land titling in Ghana and Nigeria. | Still in early adoption; requires specific blockchain ecosystem knowledge. |
...
1. **System Design:** Architecting the hybrid layers and data schemas.

1. **Implementation:** Coding the Flask backend and Solidity contracts.

1. **Testing:** Unit testing smart contracts and integration testing the API.

1. **Evaluation:** Benchmarking transaction times on a local Ganache network and conducting usability walkthroughs.
...
[1]: https://www.african-cities.org/wp-content/uploads/2024/05/ACRC_Working-Paper-12_May-2024.pdf "African Cities Research Consortium. (2024). Land and connectivity: Domain report. [Working Paper 12]."

[2]: https://fmhud.gov.ng/read/3506 "Federal Ministry of Housing & Urban Development. (2024 ). National Land Registration, Documentation, and Titling Programme."

[3]: https://www.vanguardngr.com/2026/02/nigeria-stagnates-on-anti-corruption-index-in-2025-cislac/ "Vanguard News. (2026, February 10 ). Nigeria stagnates on anti-corruption index in 2025 — CISLAC."
...
[8]: https://www.landano.io/resources/whitepaper "Landano. (2024). Decentralized Land Titling for Africa."

[9]: https://www.worldbank.org/en/country/nigeria/publication/nigeria-development-update-ndu "World Bank. (2025 ). Nigeria Development Update (NDU): Unlocking Land Potential."
...
[12]: https://doi.org/10.1016/j.cosrev.2020.100360 "Lone, A. H., & Naaz, R. (2021). Applicability of Blockchain smart contracts in securing Internet and IoT: A systematic literature review. Computer Science Review, 39, 100360."
